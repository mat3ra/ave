...
export function ExecutionUnit({ unit, renderingContext, onUpdate, adjustable, editable = true, isStandalone, materials = [], materialsIndex, onMaterialSwitch, units = [], }) {
