...
class UnitOutput extends React.Component {
        ...
        me.timeOut = setTimeout(() => {
            if (previousScrollTop < currentScrollTop) {
                ...
                if (scrollHeight - currentScrollTop - me.outputEl.offsetHeight - margin < 10) {
                    ...
                    me.props.onOutputUpdateRequest(me.props.unit.flowchartId, me.state.skip, me.state.limit);
                }
            }
    ...
    render() {
        ...
        return (_jsxs(Stack, { overflow: "hidden", className: "UnitOutput", position: "relative", children: [_jsxs(ButtonGroup, { className: "btn-group", role: "group", sx: {
                        position: "absolute",
                        ...
                        my: 1,
                        mx: 2,
                    }, children: [_jsx(Button, { className: "btn btn-outline", onClick: this.scrollToTop, style: { display: "flex", alignItems: "center", justifyContent: "center" }, children: _jsx(IconByName, { name: "shapes.arrow.upAlt" }) }), _jsx(Button, { className: "btn btn-outline", onClick: this.scrollToBottom, style: { display: "flex", alignItems: "center", justifyContent: "center" }, children: _jsx(IconByName, { name: "shapes.arrow.downAlt" }) })] }), _jsx(Box, { overflow: "auto", ref: (e) => {
                        this.outputEl = e;
                    }, children: _jsx("pre", { className: "unit-output", id: `${unit.flowchartId}-output`, onScroll: _.debounce(this.onScroll, 100), children: output }) })] }));
    }
}
